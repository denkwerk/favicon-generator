...
// from the site root, and the head tags and manifest use the values from
// favicon.config.ts.
...
if (manifest.name !== 'Favicon Generator Nuxt Config File Example' || manifest.background_color !== '#fdf2f6') {
